...
--SELECT SPJ.SNO, J.JNAME FROM SPJ, J
--WHERE SPJ.SNO = 1 AND SPJ.JNO = J.JNO

--SELECT SPJ.SNO, P.COLOR FROM SPJ, P
--WHERE SPJ.SNO = 1 AND SPJ.PNO = P.PNO

SELECT J.JNO, SPJ.PNO, P.PNAME FROM J, SPJ, P
WHERE J.CITY = 'СМОЛЕНСК' AND SPJ.JNO = J.JNO AND SPJ.PNO = P.PNO;
